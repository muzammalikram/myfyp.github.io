                                ...
                                <form name="registration_form" id='registration_form' class="form-inline"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-3 col-xs-6">
                                            ...
                                            <select class="form-control" id="day" name="date">
                                ...
                                <form name="Login_form" id='Login_form' method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-xs-12">
                                            ...
                                            <input id="m_email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }} input-group-lg" type="text" name="email" title="Enter Email" placeholder="Your Email"/>
                                            @if ($errors->has('email'))
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('email') }}</strong>
                                    </span>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-xs-12">
                                            ...
                                            <input id="my-password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}  input-group-lg" type="password" name="password" title="Enter password" placeholder="Password"/>
                                            @if ($errors->has('password'))
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('password') }}</strong>
                                    </span>
